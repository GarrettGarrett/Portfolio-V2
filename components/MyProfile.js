    ...
    return (
      <div className="flex flex-col-reverse sm:flex-row items-start">
        ...
        <div className="flex flex-col pr-8">
          ...
          <p className= "text-gray-400 mb-16">I my use knowledge of programming to find creative and unique solutions to complex problems motivated by the desire to help others.</p>
        </div>
